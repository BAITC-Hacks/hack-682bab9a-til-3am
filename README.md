...
- `json/api_products.json` и `json/api_products_page2.json` — две страницы каталога, всего 40 уникальных товаров.
- `json/api_products_detail.json` — подробная карточка товара `515291`, включая характеристики и остатки по складам.
